...
internal constructor(
     ...
     * This method automatically searches for following clusters in the chain and reads from them appropriately.
     *
     * @param offset
     * The offset in bytes where reading shall start.
     * @param dest
     * The destination buffer the contents of the chain shall be copied to.
     * @throws IOException
     * If reading fails.
     */
    internal fun read(offset: Long, dest: ByteBuffer) {
        ...
        // if the offset is not a multiple of the cluster size we have to start reading directly in the cluster
     ...
     * @param source
     * The buffer which holds the contents which shall be transferred into the cluster chain.
     * @throws IOException
     * If writing fails.
     */
