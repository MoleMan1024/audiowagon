...
class ContentHierarchyUnknAlbum(
    ...
    private fun createPseudoPlayAllItem(): MediaItem {
        val playAllTracksForUnknAlbum = replaceType(id, AudioItemType.TRACKS_FOR_UNKN_ALBUM)
        val description = MediaDescriptionCompat.Builder().apply {
            setMediaId(playAllTracksForUnknAlbum)
    ...
    override suspend fun getAudioItems(): List<AudioItem> {
        ...
        try {
            tracks = repo.getTracksWithUnknAlbumForArtist(getDatabaseID(id))
